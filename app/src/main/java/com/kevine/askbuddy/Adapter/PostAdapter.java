...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull final Viewholder holder, int position) {
        ...
        holder.more.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                if (post.getPublisher().endsWith(firebaseUser.getUid())) {
                    AlertDialog alertDialog = new AlertDialog.Builder(mContext).create();
                    alertDialog.setTitle("Do you want to delete post?");
                    ...
                    alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(final DialogInterface dialog, int which) {
                            FirebaseDatabase.getInstance().getReference().child("Posts")
                                    .child(postId).child(post.getId()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
...
//                            });
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        public Viewholder(@NonNull View itemView) {
            ...
            final TextView share = itemView.findViewById(R.id.share);
            share.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String subject = username.getText().toString();
